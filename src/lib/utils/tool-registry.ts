...
// ---------------------------------------------------------------------------
// Shared loaders for PDF tools (kept as 2 standalone pages)
// ---------------------------------------------------------------------------
const loadPdfSuite: ToolComponentLoader = () =>
  import('@/components/tools/PdfSuite').then((m) => m.PdfSuite);

export const TOOL_REGISTRY = {
  // =========================================================================
  // PDF — 2 standalone pages
  // =========================================================================
  'pdf-tools': {
    name: 'PDF Converter',
    description: 'Convert PDFs to images, Word, or create from files.',
    tags: ['pdf-tools'],
    icon: 'FileText',
    featured: true,
    keywords: [
      'pdf', 'image', 'png', 'convert', 'extract', 'word', 'docx',
    ],
    component: loadPdfSuite,
  },
  'pdf-to-image': {
    name: 'PDF to Image',
  ...
  'pdf-editor': {
    name: 'PDF Editor',
    description: 'Edit, merge, split, compress, and watermark PDF files.',
    tags: ['pdf-tools'],
    icon: 'FilePenLine',
    featured: true,
    keywords: [
      'pdf', 'edit', 'annotate', 'signature', 'rotate', 'reorder', 'delete',
      'merge', 'combine', 'join', 'split', 'extract', 'pages', 'compress',
      'shrink', 'optimize', 'watermark', 'stamp', 'confidential',
    ],
    component: loadPdfSuite,
  },
  'pdf-split': {
  ...
  // =========================================================================
  // IMAGE — standalone tools (converter has crop/resize/compress built in)
  // =========================================================================
  'image-converter': {
    name: 'Image Converter & Editor',
    description: 'Convert formats, resize, crop, compress, and filter images.',
    tags: ['image-tools'],
    icon: 'Image',
    featured: true,
    keywords: [
      'image', 'convert', 'resize', 'rotate', 'flip', 'filters', 'ico',
      'favicon', 'compress', 'optimize', 'shrink', 'crop', 'aspect ratio',
      'webp', 'png', 'jpeg', 'jpg',
    ],
    component: () =>
  ...
  'image-tools': {
    ...
    tags: ['image-tools'],
    icon: 'Image',
    keywords: ['image', 'convert', 'resize', 'rotate', 'crop', 'compress'],
    hidden: true,
    component: () =>
      import('@/components/tools/ImageConverter').then((m) => m.ImageConverter),
  },
  ...
  'svg-to-png': {
    ...
    component: () =>
      import('@/components/tools/SvgToPng').then((m) => m.SvgToPng),
  },
  'exif-viewer-remover': {
    ...
    component: () =>
      import('@/components/tools/ExifViewerRemover').then((m) => m.ExifViewerRemover),
  },

  // =========================================================================
  // COLOR — standalone tools
  // =========================================================================
  'color-picker': {
    name: 'Color Picker',
    ...
    icon: 'Pipette',
    keywords: [
      'color', 'picker', 'eyedropper', 'palette', 'hex', 'rgb', 'hsl', 'css', 'swatch',
    ],
    component: () =>
      import('@/components/tools/ColorPicker').then((m) => m.ColorPicker),
  },
  'color-tools': {
    name: 'Color Picker',
    description: 'Pick colors, adjust color channels, and get CSS codes.',
  ...
  'color-palette-extractor': {
    ...
    component: () =>
      import('@/components/tools/ColorPaletteExtractor').then((m) => m.ColorPaletteExtractor),
  },
  'color-blindness-simulator': {
    ...
    component: () =>
      import('@/components/tools/ColorBlindnessSimulator').then((m) => m.ColorBlindnessSimulator),
  },

  // =========================================================================
  // DATA FORMATTERS & VALIDATORS — standalone tools
  // =========================================================================
  'json-formatter': {
  ...
  // =========================================================================
  // DOCUMENT TOOLS — standalone
  // =========================================================================
  'markdown-editor': {
    name: 'Markdown Editor & Exporter',
    description: 'Write, preview, and export Markdown to PDF, HTML, and PNG.',
    tags: ['text-tools', 'pdf-tools', 'converters'],
    icon: 'FileText',
    keywords: [
      'markdown', 'preview', 'render', 'editor', 'write', 'html', 'export',
      'pdf', 'png', 'jpg', 'print',
    ],
    component: () =>
  ...
  'document-converter': {
    ...
    tags: ['text-tools'],
    icon: 'FileText',
    keywords: ['markdown', 'editor', 'export', 'pdf'],
    hidden: true,
    component: () =>
      import('@/components/tools/MarkdownConverter').then((m) => m.MarkdownConverter),
  },
  'markdown-to-pdf': {
    ...
    tags: ['pdf-tools', 'converters'],
    icon: 'FileText',
    keywords: ['markdown', 'pdf', 'html', 'convert', 'export'],
    hidden: true,
    component: () =>
      import('@/components/tools/MarkdownConverter').then((m) => m.MarkdownConverter),
  },
  'markdown-to-docx': {
    ...
    component: () =>
      import('@/components/tools/MarkdownToDocx').then((m) => m.MarkdownToDocx),
  },
  'html-converter': {
    name: 'HTML Converter',
    ...
    icon: 'FileCode',
    keywords: [
      'html', 'pdf', 'markdown', 'md', 'plain text', 'convert', 'export', 'print', 'css',
    ],
    component: () =>
      import('@/components/tools/HtmlConverter').then((m) => m.HtmlConverter),
  },

  // =========================================================================
  // ENCODERS & DECODERS — standalone tools
  // =========================================================================
  'base64-converter': {
  ...
  'hex-converter': {
    ...
    component: () =>
      import('@/components/tools/HexConverter').then((m) => m.HexConverter),
  },
  'html-encoder': {
  ...
  'punycode-converter': {
    ...
    component: () =>
      import('@/components/tools/PunycodeConverter').then((m) => m.PunycodeConverter),
  },

  // =========================================================================
  // URL TOOLS — standalone
  // =========================================================================
  'url-encoder': {
  ...
  'url-parser-builder': {
    ...
    component: () =>
      import('@/components/tools/UrlParserBuilder').then((m) => m.UrlParserBuilder),
  },

  // =========================================================================
  // NETWORK — standalone tools
  // =========================================================================
  'ip-lookup': {
  ...
  'password-hasher': {
    ...
    component: () =>
      import('@/components/tools/PasswordHasher').then((m) => m.PasswordHasher),
  },
  'bcrypt-hasher': {
    name: 'Bcrypt Hasher',
  ...
  'certificate-decoder': {
    ...
    component: () =>
      import('@/components/tools/CertificateDecoder').then((m) => m.CertificateDecoder),
  },

  // =========================================================================
  // DATE & TIME — standalone tools
  // =========================================================================
  'timestamp-converter': {
  ...
  'timezone-converter': {
    ...
    icon: 'Clock3',
    keywords: [
      'timezone', 'time zone', 'convert', 'date time', 'utc', 'offset', 'iana', 'world clock',
    ],
    component: () =>
      import('@/components/tools/TimezoneConverter').then((m) => m.TimezoneConverter),
  },
  'age-calculator': {
    name: 'Age Calculator',
    ...
    icon: 'Cake',
    keywords: [
      'age', 'birthday', 'date of birth', 'years', 'months', 'days', 'next birthday', 'calculator',
    ],
    component: () =>
      import('@/components/tools/AgeCalculator').then((m) => m.AgeCalculator),
  },
  'date-difference-calculator': {
    ...
    icon: 'CalendarRange',
    keywords: [
      'date', 'difference', 'duration', 'days', 'weeks', 'months', 'years', 'calculator',
    ],
    component: () =>
      import('@/components/tools/DateDifferenceCalculator').then((m) => m.DateDifferenceCalculator),
  },

  // =========================================================================
  // TEXT UTILITIES — standalone tools
  // =========================================================================
  'case-converter': {
    name: 'Case Converter',
  ...
  'find-replace': {
    ...
    component: () =>
      import('@/components/tools/FindAndReplace').then((m) => m.FindAndReplace),
  },

  // =========================================================================
  // SPEECH — standalone tools
  // =========================================================================
  'text-to-speech': {
    name: 'Text to Speech',
    ...
    component: () =>
      import('@/components/tools/TextToSpeech').then((m) => m.TextToSpeech),
  },
  'speech-tools': {
    name: 'Text to Speech',
    description: 'Convert text to spoken audio using browser speech synthesis.',
  ...
  'speech-to-text': {
    ...
    component: () =>
      import('@/components/tools/SpeechToText').then((m) => m.SpeechToText),
  },

  // =========================================================================
  // CSS GENERATORS — standalone tools
  // =========================================================================
  'glassmorphism-generator': {
    ...
    component: () =>
      import('@/components/tools/GlassmorphismGenerator').then((m) => m.GlassmorphismGenerator),
  },
  'css-generators': {
    name: 'Glassmorphism Generator',
    description: 'Design and preview glassmorphism CSS backdrop effects.',
    tags: ['design'],
    icon: 'Sparkles',
    keywords: ['glassmorphism', 'glass', 'css'],
    hidden: true,
    component: () =>
      import('@/components/tools/GlassmorphismGenerator').then((m) => m.GlassmorphismGenerator),
  },
  'box-shadow-generator': {
    ...
    icon: 'Layers',
    keywords: [
      'css', 'shadow', 'box-shadow', 'generator', 'visualizer', 'tailwind',
      'style', 'glow', 'neumorphism',
    ],
    component: () =>
      import('@/components/tools/BoxShadowVisualizer').then((m) => m.BoxShadowVisualizer),
  },

  // =========================================================================
  // ID GENERATORS — standalone tools
  // =========================================================================
  'uuid-generator': {
    name: 'UUID Generator',
  ...
  'snowflake-id-generator': {
    ...
    component: () =>
      import('@/components/tools/SnowflakeGenerator').then((m) => m.SnowflakeGenerator),
  },

  // =========================================================================
  // NUMBER CONVERTERS — standalone tools
  // =========================================================================
  ...
  'roman-numeral-converter': {
    ...
    component: () =>
      import('@/components/tools/RomanNumeralConverter').then((m) => m.RomanNumeralConverter),
  },

  // =========================================================================
  // TEST DATA — standalone tools
  // =========================================================================
  'lorem-ipsum': {
  ...
  'mock-data-generator': {
    ...
    component: () =>
      import('@/components/tools/MockDataGenerator').then((m) => m.MockDataGenerator),
  },

  // =========================================================================
  // CODE GENERATORS — standalone tools
  // =========================================================================
  'curl-to-code': {
    name: 'cURL Command to Code',
    description: 'Convert cURL commands to Fetch, Axios, Python, and more.',
    tags: ['converters'],
    icon: 'Terminal',
    keywords: ['curl', 'fetch', 'axios', 'python', 'go', 'rust', 'request', 'convert', 'snippet'],
    component: () =>
      import('@/components/tools/CurlConverter').then((m) => m.CurlConverter),
  },
  'code-generator': {
    name: 'cURL Command to Code',
    description: 'Convert cURL commands to Fetch, Axios, Python, and more.',
    tags: ['converters'],
    icon: 'Terminal',
    keywords: ['curl', 'fetch', 'axios', 'python', 'go', 'rust'],
    hidden: true,
    component: () =>
      import('@/components/tools/CurlConverter').then((m) => m.CurlConverter),
  },
  'json-to-code': {
    name: 'JSON to Code',
    description: 'Generate typed models from JSON in many languages.',
    tags: ['converters'],
    icon: 'FileCode',
    keywords: ['json', 'typescript', 'ts', 'interface', 'type', 'convert', 'generate', 'schema', 'go', 'python', 'java', 'csharp', 'rust', 'swift', 'kotlin', 'dart', 'zod', 'struct', 'class', 'dataclass'],
    component: () =>
  ...
  'percentage-calculator': {
    ...
    icon: 'Percent',
    keywords: [
      'percentage', 'percent', 'calculator', 'ratio', 'increase', 'decrease',
      'change', 'math',
    ],
    component: () =>
  ...
  'unit-converter': {
    ...
    icon: 'Scale',
    keywords: [
      'unit', 'converter', 'measurement', 'length', 'weight', 'temperature',
      'speed', 'time', 'data', 'area', 'volume',
    ],
    component: () =>
  ...
  'bmi-calculator': {
    ...
    icon: 'Scale',
    keywords: [
      'bmi', 'body mass index', 'weight', 'height', 'health', 'metric',
      'pounds', 'kilograms',
    ],
    component: () =>
  ...
  'currency-converter': {
    ...
    keywords: [
      'currency', 'exchange rate', 'forex', 'money', 'usd', 'eur', 'convert',
      'live rates',
    ],
    component: () =>
  ...
  'clamp-calculator': {
    ...
    icon: 'Maximize',
    keywords: [
      'css', 'clamp', 'fluid', 'responsive', 'typography', 'font size',
      'rem', 'px', 'calculator',
    ],
    component: () =>
